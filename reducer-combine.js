...
/**
 * This is a action creator function. That return an action buy cake
...
/**
 * This is a action creator function. That return an action buy ice cream
 * @returns {{type: *, info: string}}
 */
const buyIceCream = () => {
    return {
...
/**
 * this is a reducer function for reduce cake count
 * @param state
 * @param action
...
/**
 * this is a reducer function for reduce ice cream count
 * @param state
 * @param action
 * @returns {{numOfIceCreams: number}}
 */
